...
<html>
<head>
	<title>passport</title><meta name="viewport" content="width=device-width, initial-scale=1">
...
if(isset($_POST['subm'])){
	$sql = "INSERT INTO passport (name,phone,email,address,pincode,city,reason)
VALUES ('  ".$_POST['nam']."',' ".$_POST['phone']."',' ".$_POST['email']."',' ".$_POST['add']."',' ".$_POST['pin']."',' ".$_POST['city']."','".$_POST['reason']."')";
 ...
 ?>
	...
	<fieldset>
		<legend><center>Passport License</center></legend>
		<form action="pass.php" method="POST">
					...
					<br>
					<pre><b><p style="position: relative;">Reason For License of Passport:</b></b><textarea rows="10" cols="70" name="reason"></textarea></pre>
