...
<body oncontextmenu="return false;">
	...
	<div id="q1">
		...
		<ul id="eee">
			<li id="ww7" ><a href="viewfir.php"><center>Home</center></a></li>
			...
			<li id="ww3" style="background-color: lightgreen"><a href="criminalinfo.php"><center>Criminals</center></a><ul><li><a href="criminals.php"><center>Criminal Search</center></a></li><li><a href="addcriminals.php"><center>Add a New Criminal</center></a></li><li><a href="deletecriminals.php"><center>Delete a Criminal</center></a></li><li><a href="updatecriminals.php"><center>Update Details a Criminal</center></a></li><li><a href="listofcriminals.php"><center>List of Criminals</center></a></li></ul></li>
			
			
		</ul>
	</div>
	<div id="qqq">
		<h1 style="position: relative;left: 300px;font-family: 'Anton', sans-serif;color: green"><center>Criminals</center></h1>
		<div id="d1"><a href="criminals.php"><img src="crimi.jpg" width="200px" height="200px"><div id="d11" style=""><center><p id="p1" >Criminal Search</p></center></div></a></div>
	<div id="d2"><a href="addcriminals.php"><img src="addcrimi.png" width="200px" height="200px"><div id="d22" style=""><center><p id="p2">Add a Criminal</p></center></div></a></div>
	<div id="d3"><a href="deletecriminals.php"><img src="deletecrimi.jpg" width="200px" height="200px"><div id="d33" style=""><center><p id="p3">Delete a Criminal</p></center></div></a></div>
	<div id="d4"><a href="updatecriminals.php"><img src="updatecrimi.jpg" width="200px" height="200px"><div id="d44" style=""><center><p id="p4">Update Detail of a Criminal</p></center></div></a></div>
	<div id="d5"><a href="listofcriminals.php"><img src="listcrimi.png" width="200px" height="200px"><div id="d55" style=""><center><p id="p5">List of Criminals</p></center></div></a></div>
