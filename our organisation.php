...
<body oncontextmenu="return false;">
  ...
  <a href="suggessions.php">SUGGESSIONS</a>
	...
	<p style="font-size: 20px;font-family: sans-serif;background-color: lightgreen;"><u><b>OUR ORGANISATION</b></u></p>
	<div id="d1"><a href="missionandvission.php"><img src="missionandvission.png" width="200px" height="200px"><div id="d11" style=""><center><p id="p1" >Mission and Vision</p></center></div></a></div>
	<div id="d2"><a href="organisation.php"><img src="organisationstruct.png" width="200px" height="200px"><div id="d22" style=""><center><p id="p2">Organisation Structure</p></center></div></a></div>
	<div id="d3"><a href="home.php"><img src="policeranks.png" width="200px" height="200px"><div id="d33" style=""><center><p id="p3">Police Ranks</p></center></div></a></div>
	<div id="d4"><a href="home.php"><img src="policemedals.jpg" width="200px" height="200px"><div id="d44" style=""><center><p id="p4">Medals</p></center></div></a></div>
	<div id="d5"><a href="emregency.php"><img src="emergency.jpg" width="200px" height="200px"><div id="d55" style=""><center><p id="p5">Emergency Numbers</p></center></div></a></div>
