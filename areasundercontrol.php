...
<body oncontextmenu="return false;">
	...
	<div id="qqq">
		<h1 style="position: relative;left: 110px;font-family: 'Anton', sans-serif;top: 0px;"><center>Areas Under Control</center></h1>
			...
			<?php 
				...
				if(mysqli_num_rows($result)>0){
					...
					while($results=mysqli_fetch_array($result)){
						...
						echo "<strong>";
						echo "<p><pre>Designation                        :                     ".$results['desig']."</pre></p>";
						echo "<p><pre>Areas Under Control                :                     ".$results['areasundercontrol']."</pre></p>";
						echo "<p><pre>Police Station                     :                     ".$results['ps']."</pre></p>";
						echo "</strong>";
