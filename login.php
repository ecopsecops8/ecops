...
<html>
<head>
<title>login-ecops</title><meta name="viewport" content="width=device-width, initial-scale=1">
...
<div id="menu">
  ...
  <a href="suggessions.php">SUGGESSIONS</a>
	...
	<div id="uu">
		<img src="cops.gif" width="250px" height="100px" style="position: relative; left: 650px;top: 100px;">
<div id="login">
	 <?php 
                        if(@$_GET['empty']==true)
                        {
                    ?>
                        <div class="aa" style="width: auto;"><?php echo $_GET['empty'] ?></div>                                
                    <?php
                        }
                    ?>
                    <?php 
                        ...
                        {
                    ?>
                        <div class="aa" style="width: auto;"><?php echo $_GET['invalid'] ?></div>                                
                    <?php
                        }
                    ?>
<fieldset><legend><h2>login</h2></legend>
<form  method="POST" name="f1" action="loginprocess.php">
	<center>User Id:<input type="text" name="n1"/></center><br>
	<center>Password:<input type="password" name="p1"/></center><br><center><input type="submit" name="submit" value="submit"/> </center>
 <br>
</form>
</fieldset>
</div>
