...
VALUES (' ".$_POST['sub']."', ' ".$_POST['date']."',' ".$_POST['time']."',' ".$_POST['com']."',' ".$_POST['nam']."',' ".$_POST['phone']."',' ".$_POST['email']."',' ".$_POST['add']."',' ".$_POST['pin']."',' ".$_POST['city']."',' ".$_POST['ps1']."')";
    $result = mysqli_query($con,$sql);
    
$url="https://www.way2sms.com/api/v1/sendCampaign";
$mess="Hi There,Thanks FOr Choosing Ecops,your Complaint is successfully received and we Will come to contact u soon";
$pho=$_POST['phone'];
$message = urlencode($mess);// urlencode your message
$curl = curl_init();
curl_setopt($curl, CURLOPT_POST, 1);// set post data to true
curl_setopt($curl, CURLOPT_POSTFIELDS, "apikey=S8M149WBHLOYY51U34APR20PZK77GSFP&secret=O6DB49L7VFTZLOAL&usetype=stage&phone=$pho&senderid=ksdkamesh99@gmail.com&message=[$message]");// post data
...
if($result){
				...
				header("location:response.php?success=su");
			}
			else{
				header("location:response.php?invalid=in");
			}
