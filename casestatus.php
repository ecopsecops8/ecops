...
<body oncontextmenu="return false;">
	...
	<div id="qqq">
		<h1 style="position: relative;left: 270px;font-family: 'Anton', sans-serif;top: 70px;"><center>Case Status </center></h1>
		<div id="qq">
		
		<fieldset id="ww">
			<form id="ll">
				<center>
				Enter the case No:<br><br><br><input type="text" name="no"><br><br>
