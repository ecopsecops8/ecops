...
<body oncontextmenu="return false;">
  ...
  <a href="suggessions.php">SUGGESSIONS</a>
	...
	<div id="qq">
		<h1 style="background-color: red;"><b>Passport Status</b></h1>
		<fieldset id="ww">
			<form id="ll" action="passport.php" method="POST">
				<center>
				Enter the Application No:<br><br><br><input type="text" name="no"><br><br>
	...
	<div id="qee">
		...
		<?php 
			if(isset($_POST['sub'])){
				$sql=" SELECT * FROM passport WHERE (`passport_id` LIKE '%".$_POST['no']."%') ";
				$result = mysqli_query($con,$sql);
				if(mysqli_num_rows($result)>0){
				echo "<h2>Search Results:</h2>";
					while($results=mysqli_fetch_array($result)){
						echo "<h3>Status:".$results["status"]."</h3>";
						echo "<tr><td>"."Name"."</td><td>" . $results["name"] . "</td></tr>";
						echo "<tr><td>"."Passport id"."</td><td>" . $results["passport_id"] . "</td></tr>";
                        ...
                        echo "<tr><td>"."Reason For Passport"."</td><td>" . $results["reason"] . "</td></tr>";
					}
				}
				else{
