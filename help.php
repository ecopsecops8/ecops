...
<body onload="change()" oncontextmenu="return false;">
  ...
  <a href="suggessions.php">SUGGESSIONS</a>
	...
	<div id="h">
		<center><h1 style="font-family: 'Dancing Script', cursive;font-size: 35px;color: white">We Are Here To Help You</h1></center>
		<div id="yy">
			<?php

			if(isset($_POST['subm'])){
				$sql = "INSERT INTO helpissues (name,issuetype,issuecomplete)
...
">Issue Type</p></center>
					<center><select name="issuetype" style="border-radius: 15px;height: 30px;" >
						...
						<option value="Passport Form">Passport Form</option>
						<option value="Driving Form">Driving Form</option>
						<option value="Armed License">Armed Form</option>
						<option value="passport status">Passport Status</option>
						<option value="Other">Other</option>
					</select></center>
					<center><p style="font-family: 'Bree Serif', serif;
">Issue Reason</p></center>
